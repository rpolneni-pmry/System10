...
{
    public partial class LkpCredentialConfiguration
    {
        public LkpCredentialConfiguration()
        {
            DboCredentialConfigurationEntry = new HashSet<DboCredentialConfigurationEntry>();
        }
        ...
        public virtual ICollection<DboCredentialConfigurationEntry> DboCredentialConfigurationEntry { get; set; }
