...
{
    public partial class DboCredentialHierarchy
    {
        public long BintId { get; set; }
        public long BintParentCredentialId { get; set; }
        public long BintChildCredentialId { get; set; }
        ...
        public virtual DboCredential BintChildCredential { get; set; }
        ...
        public virtual DboCredential BintParentCredential { get; set; }
    }
}
