...
{
    public partial class LkpDynamicDataType
    {
        public LkpDynamicDataType()
        {
            DboDynamicDataMap = new HashSet<DboDynamicDataMap>();
        }
        ...
        public virtual ICollection<DboDynamicDataMap> DboDynamicDataMap { get; set; }
