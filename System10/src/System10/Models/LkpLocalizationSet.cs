...
{
    public partial class LkpLocalizationSet
    {
        public LkpLocalizationSet()
        {
            LkpLocalization = new HashSet<LkpLocalization>();
        }
        ...
        public virtual ICollection<LkpLocalization> LkpLocalization { get; set; }
