...
{
    public partial class DboSocialConversationDismissal
    {
        public long BintId { get; set; }
        public long BintSocialConversationEntryId { get; set; }
        ...
        public virtual DboSocialConversationEntry BintSocialConversationEntry { get; set; }
    }
}
