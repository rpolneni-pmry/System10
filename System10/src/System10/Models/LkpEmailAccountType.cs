...
{
    public partial class LkpEmailAccountType
    {
        public LkpEmailAccountType()
        {
            DboEmailServer = new HashSet<DboEmailServer>();
        }
        ...
        public virtual ICollection<DboEmailServer> DboEmailServer { get; set; }
